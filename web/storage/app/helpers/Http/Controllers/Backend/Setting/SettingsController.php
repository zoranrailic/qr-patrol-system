...
class SettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        if (!$data) {
            ...
            return redirect()->route($this->getRoute())->with('error', 'Setting not found.');
        }
        $data->form_action = $this->getRoute() . '.update';
        $data->button_text = 'Update';
        $data->qr = json_encode(['url' => url('/'), 'key' => $data->key_app]); // Changed to use json_encode for proper JSON format
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            // Log the exception details to diagnose issues
