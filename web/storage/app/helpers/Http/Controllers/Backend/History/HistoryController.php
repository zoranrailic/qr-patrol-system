            ...
            return $datatables->of(History::all())
                ->addColumn('action', function (History $data) {
                    ...
                    if (Auth::user()->hasRole('administrator')) {
                        ...
                        // Zo! Disabled dugmad
                        $button .= '<div class="col-sm-4"><a href="#"><button class="btn btn-primary disabled" style="pointer-events: none;"><i class="fa fa-edit"></i></button></a></div>';
                        $button .= '<div class="col-sm-4"><a href="#"><button class="btn btn-danger disabled" style="pointer-events: none;"><i class="fa fa-trash"></i></button></a></div>';
                    }
