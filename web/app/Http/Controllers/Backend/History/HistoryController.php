...
class HistoryController extends Controller
{
            ...
            return $datatables->of(History::all())
                ->addColumn('action', function (History $data) {
                    ...
                    if (Auth::user()->hasRole('administrator')) {
                        ...
                        // Zo! Disabled dugmad sa pointer-events: none i tooltipom
                        $button .= '<div class="col-sm-4"><a href="#"><button class="btn btn-primary disabled" style="pointer-events: none;" title="Nemate dozvolu"><i class="fa fa-edit"></i></button></a></div>';
                        $button .= '<div class="col-sm-4"><a href="#"><button class="btn btn-danger disabled" style="pointer-events: none;" title="Nemate dozvolu"><i class="fa fa-trash"></i></button></a></div>';
                    }
    ...
    public function add()
    {
        if (!Auth::user() || !Auth::user()->hasRole('administrator')) {
            return redirect()->route('histories')->with('error', 'Nemate dozvolu za pristup.');
        }
