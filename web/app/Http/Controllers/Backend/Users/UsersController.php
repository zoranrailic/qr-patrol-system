            ...
            return $datatables->of(User::with('roles')->get())  // Assuming 'roles' is the correct relationship name
                ...
                ->addColumn('action', function (User $data) {
                    ...
                    if (Auth::user()->hasRole('administrator')) {
                        ...
                        $button = '<a href="#"><button class="btn btn-primary disabled" style="pointer-events: none;"><i class="fa fa-edit"></i></button></a> ';
                        $button .= '<a href="#"><button class="btn btn-danger disabled" style="pointer-events: none;"><i class="fa fa-trash"></i></button></a>';
                    }
