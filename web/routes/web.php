...
Route::group(['middleware' => ['role:administrator|admin']], function () {
    Route::get('/histories', [HistoryController::class, 'index'])->name('histories');
    Route::get('/histories/add', [HistoryController::class, 'index'])->name('histories.add');
    Route::post('/histories/create', [HistoryController::class, 'index'])->name('histories.create');
    Route::get('/histories/edit/{id}', [HistoryController::class, 'index'])->name('histories.edit');
    Route::post('/histories/update', [HistoryController::class, 'index'])->name('histories.update');
    Route::get('/histories/delete/{id}', [HistoryController::class, 'index'])->name('histories.delete');

    Route::get('/histories/import', [HistoryController::class, 'index'])->name('histories.import');
    Route::post('/histories/importData', [HistoryController::class, 'index'])->name('histories.importData');
    Route::get('/histories/downloadQrCode/{dataQr}/{name}', [QrCodeController::class, 'downloadQrCode'])->name('histories.downloadQrCode');
});
